...
def plot_statistics(player_win, opponent_wins, draws, player_steps,  player_sequences, player_name, opponent_name, title):
    ...
    plt.savefig(f"./Computational_Intelligence/Quixo/{title}_{player_name}_victory_lines_count.png")
    ...
    if len(player_steps) > 0:
        ...
        plt.savefig(f"./Computational_Intelligence/Quixo/{title}_{player_name}_victory_steps.png")  # Salvataggio e chiusura
        plt.close()
    ...
    plt.savefig(f"./Computational_Intelligence/Quixo/{player_name}_vs_{opponent_name}_results.png")
    plt.close()
